...
┏━⊜ Hai *%name* ━⊜
父 *Level:* %level 
父 *Total Pengguna:* %totalreg 
父 *Library:* nanda-devsockets/Baileys
┗━━━━━━━━━━⬣
This bot was created to make it easier for users to carry out their activities. Hello everyone! I will be happy to help you all!
─────────────
Ⓛ = Use Limit 
Ⓟ = For Premium 
-----  -----  -----  -----  -----  -----
    ...
    message: {
        ...
        contextInfo: {
          ...
          header: proto.Message.InteractiveMessage.Header.create({
            ...
            subtitle: "Nanda-Dev",
            hasMediaAttachment: true,...(await prepareWAMessageMedia({ document: fs.readFileSync('./index.js'), mimetype: 'application/pdf', fileName: `Version: ${botversi}`, fileLength: 0 }, { upload: conn.waUploadToServer }))
          }),
