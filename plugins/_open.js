let handler = async (m, { conn, command, args, text, usedPrefix }) => {
  try {
    let bruh = `Contoh penggunaan: *${usedPrefix}open common 10*\n\nlist crate:\n*common*\n*uncommon*\n*mythic*\n*legendary*`
    let _lmao = args[0]
...
`.trim()
                    if (global.db.data.users[m.sender].common >= 1000) {
                        ...
                        global.db.data.users[m.sender].balance += cm3 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].uncommon >= 1) {
                        ...
                        global.db.data.users[m.sender].balance += um * 1
...
`.trim()
                    if (global.db.data.users[m.sender].uncommon >= 100) {
                        ...
                        global.db.data.users[m.sender].balance += um2 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].uncommon >= 1000) {
                        ...
                        global.db.data.users[m.sender].balance += um3 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 1) {
                        ...
                        global.db.data.users[m.sender].balance += mm * 1
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 100) {
                        ...
                        global.db.data.users[m.sender].balance += mm2 * 1
...
`.trim()
                    if (global.db.data.users[m.sender].mythic >= 1000) {
                        ...
                        global.db.data.users[m.sender].balance += mm3 * 1
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 1) {
                        ...
                        global.db.data.users[m.sender].balance += lm * 1
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 100) {
                        ...
                        global.db.data.users[m.sender].balance += lm2 * 1
...
`.trim()  
                    if (global.db.data.users[m.sender].legendary >= 1000) {
                        ...
                        global.db.data.users[m.sender].balance += lm3 * 1
