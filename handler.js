    ...
    async participantsUpdate({ id, participants, action, m }) {
        ...
        let catalog = generateWAMessageFromContent(
            ...
            proto.Message.fromObject({
                "productMessage": {
                    "product": product,
                    "businessOwnerJid": '6285812273035@s.whatsapp.net'
                }
            }),
            { userJid: id }
        );
